...
Router.route('addmap')
var googlemapkey=Meteor.settings.public.mapapikey;
Router.onBeforeAction(function() {
  ...
  this.next();
}, { only: ['home', 'itineraries','groupCampPost','addmap','showSearch','map'] });
...
Router.onBeforeAction(requireLogin, {
  ...
  except: ['signup', 'home','login','searchresults', 'pastitin']
});
...
Router.route('/showuser/:_id',
  {name:"showUser",
   data: function(){
    const c = Meteor.users.findOne({_id:this.params._id});
    return c;
    }
   }
