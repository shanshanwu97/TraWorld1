...
var ft1954031 = {
	params:window.ftParams_1954031||"",
	confID:window.ftConfID_1954031||"0",
	guid:window.ftGUID_1954031||"99999999999",
	ftId:'',
    ftImpId: window.ftImp1954031 && window.ftImp1954031.impID || '',
	pID:1954031,
	creativeID:"1456248",
	campaignID: "64285",
	exttrack:[],
	...
	width:"728",
	height:"90",
	altimg:"http://cdn.flashtalking.com/xre/195/1954031/1456248/image/1456248.gif",
	viewableImpressionURL: "http://servedby.flashtalking.com/imp/8/64285;1954031;202;pixel;JMProgrammaticBuyingPlatform;A9IOSOffer2016Q2AllJMPBPBannerSRTYPagesUSEN728x90/?",
    stump: "http://servedby.flashtalking.com",
	altimghref:"http://servedby.flashtalking.com/click/8/64285;1954031;1456248;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://developer.amazon.com/public/apis/earn/mobile-ads/iosoffer?sc_channel=BA&sc_brand=Mobile_Ads&sc_campaign=MobileAdsiOSOffer&sc_publisher=JMPBP&sc_medium=retargeting&sc_detail=728x90&sc_content=v1_728x90&sc_country=WW&sc_category=MobileAdsiOSOffer",
	switchArray:["altimg", "altimghref", "cdnSrc", "cdnGUID", "iDeviceImp", "statBaseURL", "viewableImpressionURL", "cdnSrc", "iDeviceImp"],
	statBaseURL:"http://stat8.flashtalking.com/reportV3/ft.stat?68363020-1954031;1456248;",
	divID:"ftdiv1954031",
	altimgID:"ftalt1954031",
    imgID: "ftImg1954031",
    frameID:"ftframe1954031",
	alttext:"Click here",
	altimgtarget:"_blank",
	altimgborder:"0",
	centreAd:true,
	...
	iDeviceImp:"http://servedby.flashtalking.com/imp/8/64285;1954031;207;guid;JMProgrammaticBuyingPlatform;A9IOSOffer2016Q2AllJMPBPBannerSRTYPagesUSEN728x90/?ft_guid=",
	secure: location.protocol === 'https:'||!!(document.querySelector&&document.querySelector('#ftscript_m1954031[src^="https:"]')) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc','')),
	adDisplayed: false,
    w: window,
    qsVars:[
        ["ftguid","ftGUID_1954031"],
        ["ftcfid","ftConfID_1954031"],
        ["ftcustom","ftCustom_1954031"],
        ["fttime","ftTimestamp_1954031"],
        ["ftsection","ftSection_1954031"],
        ["ft_id", "ftID"],
        ['ftimpid', 'ftImp1954031', 'impID']
    ],
	api: {
		fallbackAPI: {
            ft: null,
	...
	scriptLocation: document.getElementById('ftscript_m1954031'),
	$:function(el){
		var o=this,
		x = el||o.divID,
		p={o:o};
	...
	outputDiv:function(frame){
		...
		div += o[content]();
		div += '</div>';
		if(window.ftImp1954031 && window.ftImp1954031.jsAppend) {
    ...
    convertUrlProtocol: function(url) {
        return (this.secure ? 'https:' : 'http:') + url.substring(url.indexOf('/'), url.length);
    },
	getBackup:function(){
