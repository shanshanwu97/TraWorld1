(function () {
  ...
  if(typeof __adroll.fb === 'undefined'){
        fbq('init', '168037960209485');
    __adroll.fb=true;
    fbq('track', "PageView", {segment_eid: ["LO4TP2UD6JCT5HI4PCTLIH"]});
} else {
    fbq('track', "CustomEvent", {event: "EventSegment", segment_eid: ["LO4TP2UD6JCT5HI4PCTLIH"]});
}
  ...
  if (typeof __adroll.set_pixel_cookie != 'undefined') {__adroll.set_pixel_cookie(adroll_adv_id, adroll_pix_id, "LO4TP2UD6JCT5HI4PCTLIH");}
}());
