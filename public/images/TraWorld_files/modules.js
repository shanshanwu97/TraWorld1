...
install("iron:core");                                                        // 77
install("iron:dynamic-template");                                            // 78
install("iron:layout");                                                      // 79
install("iron:url");                                                         // 80
install("iron:middleware-stack");                                            // 81
install("iron:location");                                                    // 82
install("reactive-dict");                                                    // 83
install("iron:controller");                                                  // 84
install("iron:router");                                                      // 85
install("twbs:bootstrap");                                                   // 86
install("ddp-rate-limiter");                                                 // 87
install("localstorage");                                                     // 88
install("callback-hook");                                                    // 89
install("accounts-base", "meteor/accounts-base/client_main.js");             // 90
install("url");                                                              // 91
install("oauth");                                                            // 92
install("accounts-oauth");                                                   // 93
install("service-configuration");                                            // 94
install("oauth2");                                                           // 95
install("google");                                                           // 96
install("accounts-google");                                                  // 97
install("session");                                                          // 98
install("stylus");                                                           // 99
install("anti:i18n");                                                        // 100
install("npm-bcrypt");                                                       // 101
install("sha");                                                              // 102
install("srp");                                                              // 103
install("accounts-password");                                                // 104
install("ian:accounts-ui-bootstrap-3");                                      // 105
install("dburles:google-maps");                                              // 106
install("mdg:geolocation");                                                  // 107
install("fortawesome:fontawesome");                                          // 108
install("froala:editor");                                                    // 109
install("froala:editor-reactive");                                           // 110
install("cfs:base-package");                                                 // 111
install("livedata");                                                         // 112
install("mongo-livedata");                                                   // 113
install("raix:eventemitter");                                                // 114
install("cfs:storage-adapter");                                              // 115
install("cfs:filesystem");                                                   // 116
install("less");                                                             // 117
install("cfs:standard-packages");                                            // 118
install("fourseven:scss");                                                   // 119
install("webapp");                                                           // 120
install("hot-code-push");                                                    // 121
install("launch-screen");                                                    // 122
install("http");                                                             // 123
install("cfs:data-man");                                                     // 124
install("cfs:file");                                                         // 125
install("cfs:tempstore");                                                    // 126
install("cfs:http-methods");                                                 // 127
install("cfs:http-publish");                                                 // 128
install("cfs:access-point");                                                 // 129
install("cfs:reactive-property");                                            // 130
install("cfs:reactive-list");                                                // 131
install("cfs:power-queue");                                                  // 132
install("cfs:upload-http");                                                  // 133
install("cfs:collection");                                                   // 134
install("cfs:collection-filters");                                           // 135
install("cfs:worker");                                                       // 136
