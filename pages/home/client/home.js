...
Template.home.events({
  ...
  "click .js-gojapan":function(event){
    Session.set("cityinfo", "http://www.japanvisitor.com/tokyo/tokyo-facts");
  },
  "click .js-goparis":function(event){
    Session.set("cityinfo", "http://goparis.about.com/od/gettingaround/p/CityProfile.htm");
  },
  "click .js-gosydney":function(event){
    Session.set("cityinfo", "http://www.encyclopedia.com/topic/Sydney.aspx");
  },
  "click .js-golondon":function(event){
    Session.set("cityinfo", "http://www.londonguestguide.com/");
  },

})
Template.travelInfo.helpers({
  cityinfo:function(){
    var link=Session.get("cityinfo");
    return link;
  }
})
